...
export type GetAttestationQuery = {
  __typename?: 'Query'
  getAttestation?: {
    __typename?: 'Attestation'
    attester: string
 ...
 * });
 */
export function useGetAttestationQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetAttestationQuery,
    GetAttestationQueryVariables
  > &
    (
      | { variables: GetAttestationQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetAttestationQuery, GetAttestationQueryVariables>(
    GetAttestationDocument,
    options
  )
}
export function useGetAttestationLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetAttestationQuery, GetAttestationQueryVariables>(
    GetAttestationDocument,
    options
  )
}
export function useGetAttestationSuspenseQuery(
  ...
  return Apollo.useSuspenseQuery<
    GetAttestationQuery,
    GetAttestationQueryVariables
  >(GetAttestationDocument, options)
}
export type GetAttestationQueryHookResult = ReturnType<
  typeof useGetAttestationQuery
>
export type GetAttestationLazyQueryHookResult = ReturnType<
  typeof useGetAttestationLazyQuery
>
export type GetAttestationSuspenseQueryHookResult = ReturnType<
  typeof useGetAttestationSuspenseQuery
>
export type GetAttestationQueryResult = Apollo.QueryResult<
  GetAttestationQuery,
  GetAttestationQueryVariables
>
 ...
 * });
 */
export function useAttestationsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    AttestationsQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<AttestationsQuery, AttestationsQueryVariables>(
    AttestationsDocument,
    options
  )
}
export function useAttestationsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    AttestationsQuery,
    AttestationsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<AttestationsQuery, AttestationsQueryVariables>(
    AttestationsDocument,
    options
  )
}
export function useAttestationsSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    AttestationsQuery,
    AttestationsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useSuspenseQuery<AttestationsQuery, AttestationsQueryVariables>(
    AttestationsDocument,
    options
  )
}
export type AttestationsQueryHookResult = ReturnType<
  typeof useAttestationsQuery
>
export type AttestationsLazyQueryHookResult = ReturnType<
  typeof useAttestationsLazyQuery
>
export type AttestationsSuspenseQueryHookResult = ReturnType<
  typeof useAttestationsSuspenseQuery
>
export type AttestationsQueryResult = Apollo.QueryResult<
  AttestationsQuery,
  AttestationsQueryVariables
>
