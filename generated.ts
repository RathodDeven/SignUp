...
export type GetAttestationQuery = { __typename?: 'Query', getAttestation?: { __typename?: 'Attestation', attester: string, time: number, decodedDataJson: string, id: string, schemaId: string } | null };
...
export type AttestationsQuery = { __typename?: 'Query', attestations: Array<{ __typename?: 'Attestation', attester: string, time: number, decodedDataJson: string, id: string, schemaId: string }> };


export const GetAttestationDocument = gql`
...
/**
 * __useGetAttestationQuery__
 *
 * To run a query within a React component, call `useGetAttestationQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAttestationQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAttestationQuery({
 *   variables: {
 *      where: // value for 'where'
 *   },
 * });
 */
export function useGetAttestationQuery(baseOptions: Apollo.QueryHookOptions<GetAttestationQuery, GetAttestationQueryVariables> & ({ variables: GetAttestationQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAttestationQuery, GetAttestationQueryVariables>(GetAttestationDocument, options);
      }
export function useGetAttestationLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAttestationQuery, GetAttestationQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAttestationQuery, GetAttestationQueryVariables>(GetAttestationDocument, options);
        }
export function useGetAttestationSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetAttestationQuery, GetAttestationQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetAttestationQuery, GetAttestationQueryVariables>(GetAttestationDocument, options);
        }
export type GetAttestationQueryHookResult = ReturnType<typeof useGetAttestationQuery>;
export type GetAttestationLazyQueryHookResult = ReturnType<typeof useGetAttestationLazyQuery>;
export type GetAttestationSuspenseQueryHookResult = ReturnType<typeof useGetAttestationSuspenseQuery>;
export type GetAttestationQueryResult = Apollo.QueryResult<GetAttestationQuery, GetAttestationQueryVariables>;
...
/**
 * __useAttestationsQuery__
 *
 * To run a query within a React component, call `useAttestationsQuery` and pass it any options that fit your needs.
 * When your component renders, `useAttestationsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useAttestationsQuery(baseOptions?: Apollo.QueryHookOptions<AttestationsQuery, AttestationsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AttestationsQuery, AttestationsQueryVariables>(AttestationsDocument, options);
      }
export function useAttestationsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AttestationsQuery, AttestationsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AttestationsQuery, AttestationsQueryVariables>(AttestationsDocument, options);
        }
export function useAttestationsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AttestationsQuery, AttestationsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AttestationsQuery, AttestationsQueryVariables>(AttestationsDocument, options);
        }
export type AttestationsQueryHookResult = ReturnType<typeof useAttestationsQuery>;
export type AttestationsLazyQueryHookResult = ReturnType<typeof useAttestationsLazyQuery>;
export type AttestationsSuspenseQueryHookResult = ReturnType<typeof useAttestationsSuspenseQuery>;
export type AttestationsQueryResult = Apollo.QueryResult<AttestationsQuery, AttestationsQueryVariables>;
